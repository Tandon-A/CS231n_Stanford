...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        W2 = np.random.normal(loc = 0.0, scale = weight_scale, size = (num_filters * H_new * W_new, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dout, dW3, db3 = affine_backward(dout, cache_fc2)
        grads['W3'] = dW3 + self.reg * W3
        grads['b3'] = db3
        
        dout, dW2, db2 = affine_relu_backward(dout, cache_fc1)
